...
```bash
curl -fsSL https://raw.githubusercontent.com/L0stInFades/ohspeed/main/scripts/install.sh | OHSPEED_VERSION=v0.5.6 bash
```

```powershell
$env:OHSPEED_VERSION = "v0.5.6"; irm https://raw.githubusercontent.com/L0stInFades/ohspeed/main/scripts/install.ps1 | iex
```
