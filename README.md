...
```bash
curl -fsSL https://raw.githubusercontent.com/L0stInFades/ohspeed/main/scripts/install.sh | OHSPEED_VERSION=v0.6.0 bash
```

```powershell
$env:OHSPEED_VERSION = "v0.6.0"; irm https://raw.githubusercontent.com/L0stInFades/ohspeed/main/scripts/install.ps1 | iex
```
